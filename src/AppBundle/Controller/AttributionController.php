...
//    }
     ...
     *
     * @Route("/end/{attribution}", options={"expose"=true})
     * @param Request $request
    ...
    /**
     * @Route("/modal/add/{membre}", options={"expose"=true})
     *
     * @param Request $request
     * @param Membre $membre
     ...
     * @return Response
     */
    public function modalAddMembreAction(Request $request, Membre $membre)
    {
...
//    }
    ...
    /**
     * @Route("/modal/add", options={"expose"=true})
     *
     * @param Request $request
     * @return Response
     */
    ...
    /**
     * @Route("/modal/edit/{attribution}", options={"expose"=true})
     *
     * @param Attribution $attribution
     * @ParamConverter("attribution", class="AppBundle:Attribution")
     * @return Response
     */
    public function modalEditAction(Attribution $attribution)
    {
        $attributionForm = $this->createForm(new AttributionType(), $attribution,
    ...
    /**
     * @Route("/modal/end/{attribution}/{dateFin}", options={"expose"=true})
     *
     * @param Attribution $attribution
     ...
     * @return JsonResponse
     */
    public function modalEndAction($attribution, $dateFin)
    {
...
//    /**
//     * @Route("/add-multi-membre", options={"expose"=true})
//     *
//     * @param Request $request
//     * @return Response
//     */
//    public function modalAddMultiMembreAction(Request $request)
//    {
//
//        $newAttribution = new Attribution();
