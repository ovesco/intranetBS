...
class ListModelsCreances
{
    ...
    static public function getDefault(\Twig_Environment $twig, $items)
    {
        ...
        $list->addAction(new ActionLigne('Afficher', 'zoom icon popupable', 'event_creance_show'));
        $list->addAction(new ActionLigne('Supprimer', 'delete icon popupable', 'event_creance_delete'));
